...
/** Resolve a `file:`-prefixed or bare path from DATABASE_URL/DATABASE_PATH. */
function resolveCliDbPath(): string {
  const raw = process.env.DATABASE_URL || process.env.DATABASE_PATH || './gameventory.db';
